  ...
  <b-row class="intro-container">
    <b-col md="6"
      ...
      <div class="lesson-info">
        ...
        <h1 class="lesson-title">Gaps</h1>
        <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Gaps lesson.</div>
