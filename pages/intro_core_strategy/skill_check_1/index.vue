  ...
  <b-row class="intro-container">
    <b-col md="6"
      ...
      <div class="lesson-info">
        ...
        <h1 class="lesson-title">Skill Check 1</h1>
        <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Skill Check 1.</div>
