    ...
    <b-row>
      <b-col md="6"
        ...
        <div class="lesson-info">
          ...
          <h1 class="lesson-title">Skill Check 6</h1>
          <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Skill Check 6.</div>
