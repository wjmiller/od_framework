  ...
  <b-row class="intro-container">
    <b-col md="6"
      ...
      <div class="lesson-info">
        ...
        <h1 class="lesson-title">Candle Sentiment</h1>
        <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Candle Sentiment lesson.</div>
...
export default {
  ...
  fetch( {
    ...
    const course = {
      ...
      lesson = {
        id: 'intro_core_candle_sentiment',
        title: 'Candle Sentiment'
      }
