    ...
    <b-row>
      <b-col md="6"
        ...
        <div class="lesson-info">
          ...
          <h1 class="lesson-title">Professional and Novice Gaps</h1>
          <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Professional and Novice Gaps lesson.</div>
...
export default {
  ...
  fetch( {
    ...
    const course = {
      ...
      lesson = {
        id: 'intro_core_gaps_professional_novice',
        title: 'Professional and Novice Gaps'
      }
