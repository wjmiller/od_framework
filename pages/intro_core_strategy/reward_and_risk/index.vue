  ...
  <b-row class="intro-container">
    <b-col md="6"
      ...
      <div class="lesson-info">
        ...
        <h1 class="lesson-title">Reward and Risk</h1>
        <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Reward and Risk lesson.</div>
...
export default {
  ...
  fetch( {
    ...
    const course = {
      ...
      lesson = {
        id: 'intro_core_reward_risk',
        title: 'Reward and Risk'
      }
