    ...
    <b-row>
      <b-col md="6"
        ...
        <div class="lesson-info">
          ...
          <h1 class="lesson-title">Maximize Your Profit Revisited</h1>
          <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Maximize Your Profit Revisited lesson.</div>
...
export default {
  ...
  fetch( {
    ...
    const course = {
      ...
      lesson = {
        id: 'intro_core_trade_outro',
        title: 'Maximize Your Profit Revisited'
      }
