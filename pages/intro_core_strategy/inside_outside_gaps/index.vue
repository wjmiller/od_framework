  ...
  <b-row>
    <b-col md="6"
      ...
      <div class="lesson-info">
        ...
        <h1 class="lesson-title">Inside and Outside Gaps</h1>
        <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Inside and Outside Gaps lesson.</div>
...
export default {
  ...
  fetch( {
    ...
    const course = {
      ...
      lesson = {
        id: 'intro_core_gaps_inside_outside',
        title: 'Inside and Outside Gaps'
      }
