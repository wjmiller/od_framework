    ...
    <b-row>
      <b-col md="6"
        ...
        <div class="lesson-info">
          ...
          <h1 class="lesson-title">Order States</h1>
          <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Order States lesson.</div>
