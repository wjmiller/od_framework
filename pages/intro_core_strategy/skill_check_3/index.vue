    ...
    <b-row>
      <b-col md="6"
        ...
        <div class="lesson-info">
          ...
          <h1 class="lesson-title">Skill Check 3</h1>
          <div class="lesson-description">Here is a description for this lesson. It briefly explains what is covered in the Skill Check 3.</div>
